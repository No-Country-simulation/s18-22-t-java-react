    ...
    return (
        <div className="h-[calc(100vh-112px)] flex justify-center items-center pb-10">
            ...
            <div className="max-w-[550px] px-4 text-center">
                ...
                <p className="my-4">Para la fecha de <span className="font-bold">{appointment.date}</span> a la <span className="font-bold">{appointment.starTime}</span> con el doctor <span className="font-bold">{appointment.doctorName}</span> en la <span className="font-bold">Clínica colón</span></p>
